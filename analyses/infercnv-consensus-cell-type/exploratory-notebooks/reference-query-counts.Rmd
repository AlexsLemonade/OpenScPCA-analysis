...
There are five library with an order of magnitude more reference than query cells; let's look more closely at the validation groups present to get a sense.
