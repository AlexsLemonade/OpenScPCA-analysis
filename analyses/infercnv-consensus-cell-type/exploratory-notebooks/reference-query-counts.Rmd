...
Note that we are including multiplexed libraries from project `SCPCP000009` here as well; 12 libraries from that project from are eligible, and all but one of those are multiplexed.
