...
Next, we compare labels across all three methods: if _two out of three_ methods agree, we assign the agreeing label.
...
ggplot(umap_df) +
  ...
  guides(color = guide_legend(override.aes = list(size = 2, alpha = 1), ncol=4))
```
