...
There are a few common circumstances where you might encounter this:




```{r}
# Print the cluster column from the SCE object
head(colData(sce)$cluster)
```

In this section, we'll demonstrate how you can run the `rOpenScPCA` cluster evaluation functions on these clusters.
