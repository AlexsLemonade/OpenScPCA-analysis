...
stability_results <- calculate_stability(
  sce,
  cluster_results$cluster, # TODO!!!!! Update once the rOpenScPCA hash is updated in this branch
  seed = params$seed
)
...
stability_results_leiden <- calculate_stability(
  sce,
  cluster_df_leiden$cluster, # TODO!!!!! Update once the rOpenScPCA hash is updated in this branch
  algorithm = "leiden",
  resolution = 0.5,
  nn = 15,
  seed = params$seed
