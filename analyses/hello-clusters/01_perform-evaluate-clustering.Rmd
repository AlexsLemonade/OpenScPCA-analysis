...
Because clustering involves random samples, it is important to set the random seed at the top of your analysis script or notebook to ensure reproducibilty.
...
cluster_results <- calculate_clusters(sce)
