...
Defining their locations here will make it easy for later users to know what to expect.
...
Finally, we will plot the results as a histogram, faceted and colored by project ID.
...
```{r}
ggsave(count_plot, plot_file, width = 8, height = 6)
```
