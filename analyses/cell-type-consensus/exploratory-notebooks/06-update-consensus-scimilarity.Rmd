...
I think we could just stick with our previous guidelines of choosing the label with the fewest descendants or is the most specific term. 
...
It looks like there are occassions where the lca term is both `hematopoietic precursor cell` and `stem cell`. 
