...
Previously when we looked at the LCA for pairs with moret than 1 match, we had seen only very broad cell types. 
...
Then if multiple LCA remain we find the LCA of all the remaining LCA's and if that new LCA meets our criteria we use that instead. 
...
```{r}
# firt get a dataframe of the matches we will keep that had multiple LCA and their final annotations
