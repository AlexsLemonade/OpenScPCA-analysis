...
Here we will look specifically at all T cells and anything in the myeloid lineage, which includes macrophages, monocytes, mononuclear phagocytes, myeloid leukoctyes, and neutrophils. 
...
- As expected based on the previous plot, glioblastoma appears to have a higher proportion of T cells when compared to myleoid cells across all samples. 
