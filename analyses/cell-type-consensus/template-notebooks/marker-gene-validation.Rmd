...
# path to the `2025-03-20` release results directory
results_dir <- file.path(module_base, "..", "..", "data", "2025-03-20", "results", "cell-type-consensus", params$project_id)
```
...
stopifnot(
  "No cell type results found in data/2025-03-20/results/cell-type-consensus. Please make sure you downloaded result files with the flag `--release 2025-03-20`." = length(consensus_results_files) > 0,
  "No gene expression files found in data/2025-03-20/results/cell-type-consensus. Please make sure you downloaded result files with the flag `--release 2025-03-20`." = length(gene_exp_files) > 0
)
```
