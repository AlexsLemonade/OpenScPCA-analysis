...
if(dim(srat)[2] < 100){
 s <- RunAzimuth_small(srat, reference =path_to_reference, assay = 'RNA',k.weight = 10, mapping.score.k = 80, ksmooth = 80)
} else {
 s <- RunAzimuth(srat, reference =path_to_reference,assay = 'RNA' )
