...
metadata_to_trasfer <- s@meta.data[, c("predicted.annotation.l1.score", "predicted.annotation.l1", "predicted.annotation.l2.score", "predicted.annotation.l2", "predicted.organ.score", "predicted.organ")]
srat <- AddMetaData(srat, metadata_to_trasfer, col.name = c("fetal_full_predicted.annotation.l1.score", "fetal_full_predicted.annotation.l1", "fetal_full_predicted.annotation.l2.score", "fetal_full_predicted.annotation.l2", "fetal_full_predicted.organ.score", "fetal_full_predicted.organ"))
```
...
```{r save}
saveRDS(object = srat, file = file.path(output_dir, paste0("00a-fetal_full_label-transfer_",params$sample_id,".Rds")))
```
