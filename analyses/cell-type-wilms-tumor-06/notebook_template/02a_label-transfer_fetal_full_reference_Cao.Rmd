...
query.modality = "RNA",
  ...
  ksmooth = 80 
    ...
    query <- IntegrateEmbeddings(
      ...
      verbose = verbose
            ...
            print("IntegrateEmbeddings done")
  ...
  #  query <- AddMetaData(
   #   object = query,
    #  metadata = MappingScore(anchors = anchors, ndim = dims,  ksmooth = mapping.score.k, kanchors = (k.weight+1)),
...
print(dim(srat)[2])
# this would need to be change for CI or whole sample
