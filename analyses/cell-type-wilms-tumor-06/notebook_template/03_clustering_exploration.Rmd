...
This support the need to do a proper label transfer from the fetal kidney atlas, which appears to be the best reference that can be applied to a Wilms tumor query. 
...
Stewart et al. created a [human fetal kidney atlas](https://www.kidneycellatlas.org/) [[3](https://www.science.org/doi/10.1126/science.aat5031)]. 
...
`Azimuth` also provides a human fetal atlas as a reference [[4](https://www.science.org/doi/10.1126/science.aba7721)].

The data can be found on [Zenodo](https://zenodo.org/records/4738021#.YJIW4C2ZNQI).

The reference contain cells from 15 organs including kidney from fetal samples.

We were first nicely surprised that most of the cells in the Wilms tumor dataset mapped to "kidney" organ (see previous report `02a_fetal_all_reference_Cao_{sample_id}.html`). 
