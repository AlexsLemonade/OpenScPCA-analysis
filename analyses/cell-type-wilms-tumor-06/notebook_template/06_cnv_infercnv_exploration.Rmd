...
The selection of normal cells to be spiked-in as a normal reference prior running `infercnv` has been performed in `06a_build-normal-cell_reference.R.
...
We thus decided to only take endothelial and immune cells from non-treated samples to build the reference of normal cells.
