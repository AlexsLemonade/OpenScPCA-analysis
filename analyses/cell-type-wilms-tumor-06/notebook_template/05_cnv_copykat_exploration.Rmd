...
`CopyKAT` was run using the `copyKAT.R` script with and without a normal reference, using `r params$distance` to calculate distance in `copyKAT`. 
...
predictions_paths <- c(
  no_ref = file.path(result_dir, "05_copyKAT", "noref", params$distance, predictions_file),
  with_ref = file.path(result_dir, "05_copyKAT", "ref", params$distance, predictions_file)
)
...
full_ck_result_paths <- c(
  no_ref = file.path(result_dir, "05_copyKAT", "noref", params$distance, full_ck_result_file),
  with_ref = file.path(result_dir, "05_copyKAT", "ref", params$distance, full_ck_result_file)
)
...
![](`r file.path(result_dir, "copyKAT", "noref", params$distance, glue::glue("{params$sample_id}_copykat_heatmap.jpeg"))`)

#### Heatmap with endothelial cells as reference

![](`r file.path(result_dir, "copyKAT", "ref", params$distance, glue::glue("{params$sample_id}_copykat_heatmap.jpeg"))`)
