...
```{r load}
sample_dir <- file.path(data_dir, params$sample_id)
sample_files <- list.files(sample_dir)

file <- sample_files[grepl("_processed.rds", sample_files)]

# open the processed rds object
sce <- readRDS(file.path(sample_dir, file))
```
...
This is just to get a few ideas.
