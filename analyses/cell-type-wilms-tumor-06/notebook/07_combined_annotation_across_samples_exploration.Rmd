...
do_BoxPlot_mean <- function(df, group.by, comparison){
  ...
  theme_classic()  +
  stat_compare_means( method = "wilcox.test", paired = FALSE,  hide.ns = TRUE, label = "p.signif",  bracket.size = 0.5,tip.length = 0.01 ,comparison = list(comparison), size =8, label.y = 0.9) 
