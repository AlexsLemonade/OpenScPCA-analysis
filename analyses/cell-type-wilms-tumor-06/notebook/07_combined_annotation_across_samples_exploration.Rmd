...
- Combining label transfer and CNV inference we annotated 39/40 Wilms tumor samples in SCPCP000006. For the remaining samples (SCPCS000203), we need to investigate inferCNV further, since for some reason inferCNV removes cells from the inference and errors.
