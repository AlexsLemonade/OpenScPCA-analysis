...
# Determine which sample ids to loop over, which differs if we are testing
if (params$sample_ids == "") {
  ...
  sample_ids <- stringr::str_split_1(params$sample_ids, ",")
  stopifnot(
    "Could not determine the sample_ids from the provided param value." =
      all(sample_ids %in% metadata$scpca_sample_id)
  )
}
