...
# read in ck results from both reference types (no_normal and with_normal)
...
We also see that the Kappa values range are close to 1, indicating almost perfect agreement. 
