...
infer_cnv_dir <- file.path(module_base, "results", "infercnv", "SCPCL000822")

# add code to read in both ref and no ref? 
```
...
Below is the heatmap produced by `InferCNV` showing the CNV's for each cell. 
...
![InferCNV Heatmap - Endothelial cells as reference](results/infercnv/SCPCL000822/infercnv.png)
...
I think with the combination of marker gene expression and CNVs, the bottom group of cells represent the tumor cells. 

## Do the same thing but without a reference set of cells? 
