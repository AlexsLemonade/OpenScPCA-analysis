...
params:
  ...
  tumor_markers_file: "../references/tumor-marker-genes.tsv"
  visser_markers_file: "../references/visser-all-marker-genes.tsv"
...
# output annotations
cellassign_annotations_file <- file.path(params$results_dir, glue::glue("{params$library_id}_cellassign-annotations.tsv"))
```
