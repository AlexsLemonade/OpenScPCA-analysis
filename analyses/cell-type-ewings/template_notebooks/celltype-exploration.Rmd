...
auc_df <- all_info_df |> 
  ...
  dplyr::mutate(
    auc_assignment =  auc_value > threshold
  )
```


```{r, fig.height=10, fig.width=10}
expression_umap(auc_df, auc_value)
```
...
ggplot(auc_df, aes(x = auc_value, color = auc_assignment, fill = auc_assignment)) +
...
annotated_exp_heatmap(
  ...
  annotation_column = "singler_lumped", 
