...
```{r base paths}
# The base path for the OpenScPCA repository, found by LICENSE.md file
# can't use .git because GHA doesn't find .git
repository_base <- rprojroot::find_root(rprojroot::has_file("LICENSE.md"))
