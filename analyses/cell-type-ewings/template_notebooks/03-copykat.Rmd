...
params:
  ...
  no_ref_copykat_results: "../results/annotate_tumor_cells_output/SCPCS000490/no_reference"
  with_ref_copykat_results: "../results/annotate_tumor_cells_output/SCPCS000490/with_reference"
---
...
copykat_objs <- c(
  ...
  with_ref = file.path(params$with_ref_coypkat_results, obj_file)
) |> 
