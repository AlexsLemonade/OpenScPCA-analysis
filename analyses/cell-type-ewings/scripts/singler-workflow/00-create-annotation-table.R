...
# for all samples that will be used in the SingleR reference 
...
library_pattern <- paste0(ref_file_names, collapse = "|")
annotation_files <- list.files(annotation_dir, pattern = library_pattern, recursive = TRUE, full.names = TRUE)
