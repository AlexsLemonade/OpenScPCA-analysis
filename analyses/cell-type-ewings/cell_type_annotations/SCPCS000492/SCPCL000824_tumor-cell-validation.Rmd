...
classification_df <- classification_df |>
  dplyr::mutate(
    ...
    # combined_classification = dplyr::case_when(
    #   copykat_classification == "Normal" & cnv_proportion_classification == "Normal" & marker_gene_classification == "Normal" ~ "Normal",
    #   copykat_classification == "Normal" & cnv_proportion_classification == "Reference" & marker_gene_classification == "Normal" ~ "Normal",
    #   copykat_classification == "Tumor" & cnv_proportion_classification == "Tumor" & marker_gene_classification == "Tumor" ~ "Tumor",
    #   .default = "Unknown"
    # )
  )
```
...
marker_density_df <- classification_df |> 
  ...
  dplyr::select(barcodes, gene_symbol, gene_expression, copykat_classification, cnv_proportion_classification, marker_gene_classification, combined_classification, geneset_classification) |> 
  unique() |> 
  ...
  dplyr::mutate(
    method = dplyr::case_when(
      ...
      method == "copykat_classification" ~ "CopyKAT - no reference",
      method == "cnv_proportion_classification" ~ "InferCNV proportion",
      method == "combined_classification" ~ "Combined",
...
annotation <- ComplexHeatmap::rowAnnotation(classification = annotation_df$combined_classification,
