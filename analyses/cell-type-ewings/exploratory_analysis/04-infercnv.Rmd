...
- We can define tumor cells by setting a cutoff for the number of CNVs that must be present in a cell, but I'm not sure how transferable this is to other samples. 
