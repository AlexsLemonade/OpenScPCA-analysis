...
- AUC values as calculated by `AUCell` for a set of Ewing sarcoma specific gene sets in MSigDB output by [`run-aucell-ews-signatures.sh`](https://github.com/AlexsLemonade/OpenScPCA-analysis/blob/main/analyses/cell-type-ewings/run-aucell-ews-signatures.sh). 
