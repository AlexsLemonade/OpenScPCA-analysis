...
Here the classification using expression of at least 1 marker gene is the rows and the updated classification based on `SCPCL000822` is the columns. 
...
```{r}
method_levels <- c(
  "1 marker gene" = "marker_gene_classification",
...
new_classification_df <- classification_df |> 
  dplyr::select(barcodes, ref_marker_gene_classification, consensus_classification)
