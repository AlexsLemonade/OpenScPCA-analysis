...
for(i in 1:length(marker_sum_exp)) {
  ...
  print(p)
    ...
    #save plots
  tiff(filename = paste0('../plots/UMAP_marker_expression_', names(umap_df_list)[i], '.tiff'), width = 6, height = 6, units = 'in', res = 150)
  print(p)
  dev.off()
}
...
#save plots
  tiff(filename = paste0('../plots/UMAP_classification_', names(umap_df_list)[i], '.tiff'), width = 6, height = 6, units = 'in', res = 150)
  print(p)
  dev.off()
}
...
for(i in 1:length(marker_sum_exp)) {
  ...
  #save plots
  tiff(filename = paste0('../plots/UMAP_marker_expression_cluster_', names(umap_df_list)[i], '.tiff'), width = 6, height = 6, units = 'in', res = 150)
  print(p)
  dev.off()
}
...
for(i in 1:length(marker_sum_exp)) {
  ...
  ggtitle(names(umap_df_list_excluded_scaled)[i])
  print(p)
  tiff(filename = paste0('../plots/UMAP_classification_cluster_', names(umap_df_list)[i], '.tiff'), width = 6, height = 6, units = 'in', res = 150)
  print(p)
  dev.off()
