...
- Input files
  - This includes both data files and result files from other modules, [as described on this page](../../getting-started/accessing-resources/getting-access-to-data.md)
- Output files
