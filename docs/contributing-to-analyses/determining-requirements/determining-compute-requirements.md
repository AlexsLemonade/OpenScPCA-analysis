...
However, if your module code generates large intermediate files, [document that information your module's `README.md` file](../analysis-modules/documenting-analysis.md) to help others who want to run the code.
